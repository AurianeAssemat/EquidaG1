        ...
        <div class="container">
            <div class="row">
                ...
                <form class="form-inline" action="venteModifier?id=<% out.println(uneVente.getId());%>" method="POST">
                    <label id="nom" name="nom">NOM :</label> </br>
                    <input value="<% out.println(uneVente.getNom());%>" id="nom" name="nom" type="text"/>
                    </br></br>

                    <label id="dtdebut" name="dtdebut">Date Debut Vente :</label> </br>
                    <input value="<% out.println(uneVente.getDateDebutVente());%>" id="dtdebut" name="dtdebut"  />
                    </br></br>

                    <label id="dtfin" name="dtfin">Date Fin Vente :</label> </br>
                    <input  value="<% out.println(uneVente.getDateFinVente());%>" id="dtfin" name="dtfin" />
                    </br></br>

                    <label id="dtdebutinscrip" name="dtdebutinscrip">Date Debut Inscription :</label> </br>
                    <input value="<% out.println(uneVente.getdateDebutInscrip());%>" id="dtdebutinscrip" name="dtdebutinscrip" />
                    </br></br>

                    <label id="idLieu" name="idLieu">Lieu :</label> <br>
                    ...
                    <label id="categVente" name="categVente">CATEGORIE VENTE :</label> <br> 
